...
@section('content')
    ...
    <div class = "form-group">
      ...
      {{Form::text('title', $post->title, ['class' => 'form-control', 'placeholder' => 'Type your event name here'])}}
    </div>

    <div class = "form-group">
      {{Form::label('description', 'Description')}}
      {{Form::textarea('description', $post->description, ['class' => 'form-control', 'placeholder' => 'Type your event description here'])}}
    </div>
    ...
    <div class = "form-row">
      <div class = "form-group col">
        ...
        {{Form::text('event_address', $post->event_address, ['class' => 'form-control', 'placeholder' => 'Type your event address here'])}}
      </div>

      <div class = "form-group col">
        {{Form::label('event_city', 'City')}}
        {{Form::text('event_city', $post->event_city, ['class' => 'form-control', 'placeholder' => 'Type your event city here'])}}
      </div>
    </div>
    ...
    <div class = "form-row">
      <div class = "form-group col">
        ...
        {{Form::number('event_postcode', $post->event_postcode, ['class' => 'form-control', 'placeholder' => 'Type your event Postcode here'])}}
      </div>
    ...
    <div class = "row">
        <div class = "form-group col">
          ...
          {{Form::date('event_date', $post->event_date, ['class' => 'form-control'])}}
        </div>

        <div class = "form-group col">
          {{Form::label('event_time', 'Event Time')}}
          {{Form::time('event_time', $post->event_time, ['class' => 'form-control'])}}
        </div>
      </div>
      ...
      <div class = "row">
        <div class = "form-group col">
          ...
          {{Form::date('event_enddate', $post->event_enddate, ['class' => 'form-control'])}}
        </div>

        <div class = "form-group col">
          {{Form::label('event_endtime', 'Event End Time')}}
          {{Form::time('event_endtime', $post->event_endtime, ['class' => 'form-control'])}}
        </div>
      </div
      >
      <div class = "row">  
        <div class = "form-group col">
          ...
          {{Form::date('reg_opendate', $post->reg_opendate, ['class' => 'form-control'])}}
        </div>

        <div class = "form-group col">
          {{Form::label('reg_opentime', 'Registration Open Time')}}
          {{Form::time('reg_opentime', $post->reg_opentime, ['class' => 'form-control'])}}
        </div>
      </div>
      ...
      <div class = "row">
        <div class = "form-group col">
          ...
          {{Form::date('reg_closedate', $post->reg_closedate, ['class' => 'form-control'])}}
        </div>

        <div class = "form-group col">
          {{Form::label('reg_closetime', 'Registration Close Time')}}
          {{Form::time('reg_closetime', $post->reg_closetime, ['class' => 'form-control'])}}
        </div>
      </div>

      <div class = "form-group">
        {{Form::label('event_waiver', 'Event Waiver')}}
        {{Form::textarea('event_waiver', $post->event_waiver, ['class' => 'form-control', 'placeholder' => 'Type your event waiver here'])}}
      </div>
