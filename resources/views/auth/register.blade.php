...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Register Yourself') }}</div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="role_id" id="role_id" class="form-control custom-select  @error('role_id') is-invalid @enderror"">
                                    <option value="">Choose a role for you</option>
                                    @foreach(\App\Role::all() as $role)
                                        @if($role->name == 'participant' || $role->name == 'eventDirector')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="form-text text-muted">For your login</small>
